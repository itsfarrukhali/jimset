...
export default function ElectricalProgram() {
  const program = programs.find((p) => p.slug === "electrical")!;
  return (
    <>
      <PageHero
        title={program.title}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <aside className="space-y-6">
            <div className="bg-surface p-6 rounded-xl border">
              ...
              <Button asChild className="bg-gold text-primary-dark w-full h-12">
